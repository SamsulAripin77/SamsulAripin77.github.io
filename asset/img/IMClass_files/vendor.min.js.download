if (! function(t, e) {
        ...
        function c(t, e, i, n) {
            if (st.acceptData(t)) {
                var s, o, a = st.expando,
                    ...
                    l = r ? st.cache : t,
                    h = r ? t[a] : t[a] && a;
                if (h && l[h] && (n || l[h].data) || void 0 !== i || "string" != typeof e) return h || (h = r ? t[a] = V.pop() || st.guid++ : a), l[h] || (l[h] = r ? {} : {
                    toJSON: st.noop
        ...
        function x(t, e) {
            if (1 === e.nodeType && st.hasData(t)) {
                ...
                if (r) {
                    ...
                    for (i in r)
                        for (n = 0, s = r[i].length; s > n; n++) st.event.add(e, i, r[i][n])
                }
        ...
        function T(t) {
            var e = ft,
                i = Zt[t];
            return i || (i = k(t, e), "none" !== i && i || (Jt = (Jt || st("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = (Jt[0].contentWindow || Jt[0].contentDocument).document, e.write(), e.close(), i = k(t, e), Jt.detach()), Zt[t] = i), i
        }
        ...
        function S(t, e) {
            for (var i, n, s, o = [], a = 0, r = t.length; r > a; a++) n = t[a], n.style && (o[a] = st._data(n, "olddisplay"), i = n.style.display, e ? (o[a] || "none" !== i || (n.style.display = ""), "" === n.style.display && St(n) && (o[a] = st._data(n, "olddisplay", T(n.nodeName)))) : (s = St(n), (i && "none" !== i || !s) && st._data(n, "olddisplay", s ? i : st.css(n, "display"))));
        ...
        function N(t, e, i, n, s) {
            for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === i && (a += st.css(t, i + It[o], !0, s)), n ? ("content" === i && (a -= st.css(t, "padding" + It[o], !0, s)), "margin" !== i && (a -= st.css(t, "border" + It[o] + "Width", !0, s))) : (a += st.css(t, "padding" + It[o], !0, s), "padding" !== i && (a += st.css(t, "border" + It[o] + "Width", !0, s)));
            return a
        }
        ...
        function O(t, e, i) {
            for (var n, s = (ye[e] || []).concat(ye["*"]), o = 0, a = s.length; a > o; o++)
        ...
        function z(t, e, i) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [p.overflow, p.overflowX, p.overflowY], h = st.css(t, "display"), c = "none" === h ? st._data(t, "olddisplay") || T(t.nodeName) : h, "inline" === c && "none" === st.css(t, "float") && (it.inlineBlockNeedsLayout && "inline" !== T(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), i.overflow && (p.overflow = "hidden", it.shrinkWrapBlocks() || u.always(function() {
            ...
            if (st.isEmptyObject(d)) "inline" === ("none" === h ? T(t.nodeName) : h) && (p.display = h);
                ...
                for (n in d) a = O(f ? g[n] : 0, n, u), n in g || (g[n] = a.start, f && (a.end = a.start, a.start = "width" === n || "height" === n ? 1 : 0))
            }
        }
        ...
        function F(t, e, i) {
            var n, s, o = 0,
                ...
                l = function() {
                    if (s) return !1;
                    for (var e = pe || M(), i = Math.max(0, h.startTime + h.duration - e), n = i / h.duration || 0, o = 1 - n, a = 0, l = h.tweens.length; l > a; a++) h.tweens[a].run(o);
                ...
                c = h.props;
            for (W(c, h.opts.specialEasing); a > o; o++)
                if (n = be[o].call(h, t, c, h.opts)) return n;
            return st.map(c, O, h), st.isFunction(h.opts.start) && h.opts.start.call(t, h), st.fx.timer(st.extend(l, {
                elem: t,
                anim: h,
                queue: h.opts.queue
        ...
        st.fn = st.prototype = {
            ...
            var t, e, i, n, s, o, a = arguments[0] || {},
                ...
                l = arguments.length,
                h = !1;
            for ("boolean" == typeof a && (h = a, a = arguments[r] || {}, r++), "object" == typeof a || st.isFunction(a) || (a = {}), r === l && (a = this, r--); l > r; r++)
        ...
        var ht = function(t) {
            function e(t, e, i, n) {
                ...
                if ((e ? e.ownerDocument || e : R) !== A && P(e), e = e || A, i = i || [], r = e.nodeType, "string" != typeof t || !t || 1 !== r && 9 !== r && 11 !== r) return i;
                if (!n && H) {
                    if (11 !== r && (s = bt.exec(t)))
                        if (a = s[1]) {
                            if (9 === r) {
                    ...
                    if (w.qsa && (!O || !O.test(t))) {
                        if (p = u = L, f = e, g = 1 !== r && t, 1 === r && "object" !== e.nodeName.toLowerCase()) {
                            for (h = T(t), (u = e.getAttribute("id")) ? p = u.replace(_t, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = h.length; l--;) h[l] = p + d(h[l]);
            ...
            function p(t, e, i) {
                ...
                return e.first ? function(e, i, o) {
                    ...
                    if (a) {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || s) {
                                if (l = e[L] || (e[L] = {}), (r = l[n]) && r[0] === $ && r[1] === o) return h[2] = r[2];
                ...
                var s = i.length > 0,
                    ...
                    a = function(n, a, r, l, h) {
                        var c, u, d, p = 0,
                            ...
                            w = y.length;
                        for (h && (S = a !== A && a); f !== w && null != (c = y[f]); f++) {
                            if (o && c) {
                                for (u = 0; d = t[u++];)
                                    if (d(c, a, r)) {
                                        l.push(c);
            ...
            w = e.support = {}, k = e.isXML = function(t) {
                ...
                return n !== A && 9 === n.nodeType && n.documentElement ? (A = n, M = n.documentElement, i = n.defaultView, i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", Ct, !1) : i.attachEvent && i.attachEvent("onunload", Ct)), H = !k(n), w.attributes = s(function(t) {
                    ...
                    M.appendChild(t).innerHTML = "<a id='" + L + "'></a><select id='" + L + "-\f]' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && O.push("[*^$]=" + it + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || O.push("\\[" + it + "*(?:value|" + et + ")"), t.querySelectorAll("[id~=" + L + "-]").length || O.push("~="), t.querySelectorAll(":checked").length || O.push(":checked"), t.querySelectorAll("a#" + L + "+*").length || O.push(".#.+[+~]")
                }), s(function(t) {
                ...
                })), (w.matchesSelector = vt.test(W = M.matches || M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && s(function(t) {
                    w.disconnectedMatch = W.call(t, "div"), W.call(t, "[s!='']:x"), z.push("!=", at)
                }), O = O.length && new RegExp(O.join("|")), z = z.length && new RegExp(z.join("|")), e = vt.test(M.compareDocumentPosition), F = e || vt.test(M.contains) ? function(t, e) {
                    ...
                    return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === R && F(R, t) ? -1 : e === n || e.ownerDocument === R && F(R, e) ? 1 : E ? tt(E, t) - tt(E, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return N = !0, 0;
                    var i, s = 0,
                        o = t.parentNode,
                ...
                if ((t.ownerDocument || t) !== A && P(t), i = i.replace(ut, "='$1']"), !(!w.matchesSelector || !H || z && z.test(i) || O && O.test(i))) try {
                    var n = W.call(t, i);
                        ...
                        return 1 === n && 0 === s ? function(t) {
                            ...
                            if (m) {
                                ...
                                if (f = [a ? m.firstChild : m.lastChild], a && b) {
                                    for (c = m[L] || (m[L] = {}), h = c[t] || [], p = h[0] === $ && h[1], d = h[0] === $ && h[2], u = p && m.childNodes[p]; u = ++p && u && u[g] || (d = p = 0) || f.pop();)
                                        if (1 === u.nodeType && ++d && u === e) {
                                            c[t] = [$, p, d];
                                            break
                                        }
                                } else if (b && (h = (e[L] || (e[L] = {}))[t]) && h[0] === $) d = h[1];
                                else
                                    for (;
                                        (u = ++p && u && u[g] || (d = p = 0) || f.pop()) && ((r ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++d || (b && ((u[L] || (u[L] = {}))[t] = [$, d]), u !== e)););
            ...
            return u.prototype = x.filters = x.pseudos, x.setFilters = new u, T = e.tokenize = function(t, i) {
                ...
                for (r = t, l = [], h = x.preFilter; r;) {
                    ...
                    for (a in x.filter) !(s = ft[a].exec(r)) || h[a] && !(s = h[a](s)) || (n = s.shift(),
                        o.push({
                            value: n,
                            type: a,
                            matches: s
                ...
                return (h || D(t, u))(n, e, !H, i, yt.test(t) && c(e.parentNode) || e), i
        ...
        st.extend({
            ...
            closest: function(t, e) {
                for (var i, n = 0, s = this.length, o = [], a = ct.test(t) || "string" != typeof t ? st(t, e || this.context) : 0; s > n; n++)
        ...
        st.Callbacks = function(t) {
                ...
                u = {
                    ...
                    remove: function() {
                        return l && st.each(arguments, function(t, i) {
                            for (var n;
                                (n = st.inArray(i, l, n)) > -1;) l.splice(n, 1), e && (s >= n && s--, a >= n && a--)
                        }), this
                    },
                    has: function(t) {
            ...
            when: function(t) {
                var e, i, n, s = 0,
                    ...
                    h = function(t, i, n) {
                        return function(s) {
                            i[t] = this, n[t] = arguments.length > 1 ? X.call(arguments) : s, n === e ? l.notifyWith(i, n) : --r || l.resolveWith(i, n)
                        }
                    };
                if (a > 1)
                    for (e = new Array(a), i = new Array(a), n = new Array(a); a > s; s++) o[s] && st.isFunction(o[s].promise) ? o[s].promise().done(h(s, n, o)).fail(l.reject).progress(h(s, i, e)) : --r;
        ...
        st.event = {
            ...
            add: function(t, e, i, n, s) {
                ...
                if (m) {
                    for (i.handler && (l = i, i = l.handler, s = l.selector), i.guid || (i.guid = st.guid++), (a = m.events) || (a = m.events = {}), (c = m.handle) || (c = m.handle = function(t) {
                            return typeof st === Ct || t && st.event.triggered === t.type ? void 0 : st.event.dispatch.apply(c.elem, arguments)
                        }, c.elem = t), e = (e || "").match(yt) || [""], r = e.length; r--;) o = Ot.exec(e[r]) || [], p = g = o[1], f = (o[2] || "").split(".").sort(), p && (h = st.event.special[p] || {}, p = (s ? h.delegateType : h.bindType) || p, h = st.event.special[p] || {}, u = st.extend({
                        type: p,
                        origType: g,
                        data: n,
                        handler: i,
            ...
            remove: function(t, e, i, n, s) {
                ...
                if (m && (c = m.events)) {
                    for (e = (e || "").match(yt) || [""], h = e.length; h--;)
                        if (r = Ot.exec(e[h]) || [], p = g = r[1], f = (r[2] || "").split(".").sort(), p) {
                ...
                if (r && l.nodeType && (!t.button || "click" !== t.type))
                    for (; l != this; l = l.parentNode || this)
                        if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                            for (s = [], o = 0; r > o; o++) n = e[o], i = n.selector + " ", void 0 === s[i] && (s[i] = n.needsContext ? st(i, this).index(l) >= 0 : st.find(i, this, null, [l]).length), s[i] && s.push(n);
                            s.length && a.push({
                                elem: l,
                                handlers: s
                            })
            ...
            fix: function(t) {
                ...
                var e, i, n, s = t.type,
                    o = t,
                    a = this.fixHooks[s];
                for (a || (this.fixHooks[s] = a = Mt.test(s) ? this.mouseHooks : At.test(s) ? this.keyHooks : {}), n = a.props ? this.props.concat(a.props) : this.props, t = new st.Event(o), e = n.length; e--;) i = n[e], t[i] = o[i];
        ...
        Xt.optgroup = Xt.option, Xt.tbody = Xt.tfoot = Xt.colgroup = Xt.caption = Xt.thead, Xt.th = Xt.td, st.extend({
            clone: function(t, e, i) {
                ...
                if (it.html5Clone || st.isXMLDoc(t) || !Ft.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Qt.innerHTML = t.outerHTML, Qt.removeChild(o = Qt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || st.isXMLDoc(t)))
                    for (n = m(o), r = m(t), a = 0; null != (s = r[a]); ++a) n[a] && C(s, n[a]);
                if (e)
                    if (i)
            ...
            buildFragment: function(t, e, i, n) {
                for (var s, o, a, r, l, h, c, u = t.length, d = g(e), p = [], f = 0; u > f; f++)
                    if (o = t[f], o || 0 === o)
                        if ("object" === st.type(o)) st.merge(p, o.nodeType ? [o] : o);
                        else if (Bt.test(o)) {
                    for (r = r || d.appendChild(e.createElement("div")), l = ($t.exec(o) || ["", ""])[1].toLowerCase(), c = Xt[l] || Xt._default, r.innerHTML = c[1] + o.replace(Rt, "<$1></$2>") + c[2], s = c[0]; s--;) r = r.lastChild;
                    if (!it.leadingWhitespace && Lt.test(o) && p.push(e.createTextNode(Lt.exec(o)[0])), !it.tbody)
                        for (o = "table" !== l || jt.test(o) ? "<table>" !== c[1] || jt.test(o) ? 0 : r : r.firstChild, s = o && o.childNodes.length; s--;) st.nodeName(h = o.childNodes[s], "tbody") && !h.childNodes.length && o.removeChild(h);
                ...
                for (r && d.removeChild(r), it.appendChecked || st.grep(m(p, "input"), v), f = 0; o = p[f++];)
                    if ((!n || -1 === st.inArray(o, n)) && (a = st.contains(o.ownerDocument, o), r = m(d.appendChild(o), "script"), a && w(r), i))
            ...
            cleanData: function(t, e) {
                for (var i, n, s, o, a = 0, r = st.expando, l = st.cache, h = it.deleteExpando, c = st.event.special; null != (i = t[a]); a++)
                    if ((e || st.acceptData(i)) && (s = i[r], o = s && l[s])) {
                        ...
                        l[s] && (delete l[s], h ? delete i[r] : typeof i.removeAttribute !== Ct ? i.removeAttribute(r) : i[r] = null, V.push(s))
                    }
            }
        }), st.fn.extend({
            text: function(t) {
            ...
            html: function(t) {
                return Et(this, function(t) {
                    ...
                    if (!("string" != typeof t || qt.test(t) || !it.htmlSerialize && Ft.test(t) || !it.leadingWhitespace && Lt.test(t) || Xt[($t.exec(t) || ["", ""])[1].toLowerCase()])) {
                        t = t.replace(Rt, "<$1></$2>");
                        try {
            ...
            domManip: function(t, e) {
                ...
                if (h && (r = st.buildFragment(t, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                    for (o = st.map(m(r, "script"), y), s = o.length; h > l; l++) n = r, l !== u && (n = st.clone(n, !0, !0), s && st.merge(o, m(n, "script"))), e.call(this[l], n, l);
                    if (s)
                        for (a = o[o.length - 1].ownerDocument, st.map(o, _), l = 0; s > l; l++) n = o[l], Ut.test(n.type || "") && !st._data(n, "globalEval") && st.contains(a, n) && (n.src ? st._evalUrl && st._evalUrl(n.src) : st.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Vt, "")));
                    r = i = null
                }
                return this
            }
            ...
            st.fn[t] = function(t) {
                for (var i, n = 0, s = [], o = st(t), a = o.length - 1; a >= n; n++) i = n === a ? this : this.clone(!0), st(o[n])[e](i), Q.apply(s, i.get());
        ...
        t.getComputedStyle ? (te = function(e) {
            ...
            return i = i || te(t), a = i ? i.getPropertyValue(e) || i[e] : void 0, i && ("" !== a || st.contains(t.ownerDocument, t) || (a = st.style(t, e)), ne.test(a) && ie.test(e) && (n = r.width, s = r.minWidth,
                o = r.maxWidth, r.minWidth = r.maxWidth = r.width = a, a = i.width, r.width = n, r.minWidth = s, r.maxWidth = o)), void 0 === a ? a : a + ""
        ...
        st.extend({
            ...
            style: function(t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var s, o, a, r = st.camelCase(e),
                        l = t.style;
                    if (e = st.cssProps[r] || (st.cssProps[r] = I(l, r)), a = st.cssHooks[e] || st.cssHooks[r], void 0 === i) return a && "get" in a && void 0 !== (s = a.get(t, !1, n)) ? s : l[e];
            ...
            css: function(t, e, i, n) {
                var s, o, a, r = st.camelCase(e);
                return e = st.cssProps[r] || (st.cssProps[r] = I(t.style, r)), a = st.cssHooks[e] || st.cssHooks[r], a && "get" in a && (o = a.get(t, !0, i)), void 0 === o && (o = ee(t, e, n)), "normal" === o && e in ue && (o = ue[e]), "" === i || i ? (s = parseFloat(o), i === !0 || st.isNumeric(s) ? s || 0 : o) : o
            }
        }), st.each(["height", "width"], function(t, e) {
            st.cssHooks[e] = {
                get: function(t, i, n) {
                    return i ? re.test(st.css(t, "display")) && 0 === t.offsetWidth ? st.swap(t, ce, function() {
                        return P(t, e, n)
                    }) : P(t, e, n) : void 0
                },
                set: function(t, i, n) {
                    var s = n && te(t);
                    return E(t, i, n ? N(t, e, n, it.boxSizing && "border-box" === st.css(t, "boxSizing", !1, s), s) : 0)
                }
            }
        ...
        st.fn.extend({
            ...
            attr: function(t, e, i) {
                var n, s, o = t.nodeType;
                if (t && 3 !== o && 8 !== o && 2 !== o) return typeof t.getAttribute === Ct ? st.prop(t, e, i) : (1 === o && st.isXMLDoc(t) || (e = e.toLowerCase(), n = st.attrHooks[e] || (st.expr.match.bool.test(e) ? xe : we)), void 0 === i ? n && "get" in n && null !== (s = n.get(t, e)) ? s : (s = st.find.attr(t, e), null == s ? void 0 : s) : null !== i ? n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : (t.setAttribute(e, i + ""), i) : void st.removeAttr(t, e))
            },
            removeAttr: function(t, e) {
                var i, n, s = 0,
                    o = e && e.match(yt);
                if (o && 1 === t.nodeType)
                    for (; i = o[s++];) n = st.propFix[i] || i, st.expr.match.bool.test(i) ? De && Te || !ke.test(i) ? t[n] = !1 : t[st.camelCase("default-" + i)] = t[n] = !1 : st.attr(t, i, ""), t.removeAttribute(Te ? i : n)
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            set: function(t, e, i) {
                return e === !1 ? st.removeAttr(t, i) : De && Te || !ke.test(i) ? t.setAttribute(!Te && st.propFix[i] || i, i) : t[st.camelCase("default-" + i)] = t[i] = !0, i
            }
        }, st.each(st.expr.match.bool.source.match(/\w+/g), function(t, e) {
            var i = Ce[e] || st.find.attr;
            Ce[e] = De && Te || !ke.test(e) ? function(t, e, n) {
                var s, o;
            ...
            propHooks: {
                tabIndex: {
                    get: function(t) {
                        ...
                        return e ? parseInt(e, 10) : Ie.test(t.nodeName) || Se.test(t.nodeName) && t.href ? 0 : -1
                    }
                }
            }
        ...
        Me = $e.exec(He.toLowerCase()) || [], st.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function(t, e) {
                ...
                var n, s, o, a, r, l, h, c, u = st.ajaxSetup({}, e),
                    ...
                    w = {
                        ...
                        getResponseHeader: function(t) {
                            ...
                            if (2 === y) {
                                if (!c)
                                    for (c = {}; e = We.exec(a);) c[e[1].toLowerCase()] = e[2];
                                e = c[t.toLowerCase()]
                            }
                ...
                if (f.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, u.url = ((t || u.url || He) + "").replace(Oe, "").replace(Re, Me[1] + "//"), u.type = e.method || e.type || u.method || u.type, u.dataTypes = st.trim(u.dataType || "*").toLowerCase().match(yt) || [""], null == u.crossDomain && (n = $e.exec(u.url.toLowerCase()), u.crossDomain = !(!n || n[1] === Me[1] && n[2] === Me[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Me[3] || ("http:" === Me[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = st.param(u.data, u.traditional)), R(je, u, e, w), 2 === y) return w;
                l = st.event && u.global, l && 0 === st.active++ && st.event.trigger("ajaxStart"), u.type = u.type.toUpperCase(), u.hasContent = !Le.test(u.type), o = u.url, u.hasContent || (u.data && (o = u.url += (Pe.test(o) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (u.url = ze.test(o) ? o.replace(ze, "$1_=" + Ne++) : o + (Pe.test(o) ? "&" : "?") + "_=" + Ne++)), u.ifModified && (st.lastModified[o] && w.setRequestHeader("If-Modified-Since", st.lastModified[o]), st.etag[o] && w.setRequestHeader("If-None-Match", st.etag[o])), (u.data && u.hasContent && u.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", u.contentType), w.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + qe + "; q=0.01" : "") : u.accepts["*"]);
        ...
        st.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !st(this).is(":disabled") && Xe.test(this.nodeName) && !Ve.test(t) && (this.checked || !Nt.test(t))
                }).map(function(t, e) {
                    var i = st(this).val();
        ...
        }), it.cors = !!Je && "withCredentials" in Je, Je = it.ajax = !!Je, Je && st.ajaxTransport(function(t) {
                    ...
                    send: function(i, n) {
                        ...
                        o.send(t.hasContent && t.data || null), e = function(i, s) {
                            ...
                            if (e && (s || 4 === o.readyState))
                                if (delete Qe[a], e = void 0, o.onreadystatechange = st.noop, s) 4 !== o.readyState && o.abort();
                                else {
        ...
        st.ajaxSetup({
            ...
            jsonpCallback: function() {
                var t = Ze.pop() || st.expando + "_" + Ne++;
                return this[t] = !0, t
            }
        }), st.ajaxPrefilter("json jsonp", function(e, i, n) {
            var s, o, a, r = e.jsonp !== !1 && (ti.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && ti.test(e.data) && "data");
            return r || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = st.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, r ? e[r] = e[r].replace(ti, "$1" + s) : e.jsonp !== !1 && (e.url += (Pe.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
                return a || st.error(s + " was not called"), a[0]
            }, e.dataTypes[0] = "json", o = t[s], t[s] = function() {
                a = arguments
            }, n.always(function() {
                t[s] = o, e[s] && (e.jsonpCallback = i.jsonpCallback, Ze.push(s)), a && st.isFunction(o) && o(a[0]), a = o = void 0
            }), "script") : void 0
        ...
        st.offset = {
            ...
            offset: function(t) {
                ...
                var e, i, n = {
                    ...
                    s = this[0],
                    o = s && s.ownerDocument;
                return o ? (e = o.documentElement, st.contains(e, s) ? (typeof s.getBoundingClientRect !== Ct && (n = s.getBoundingClientRect()), i = K(o), {
    ...
    }), window.jQuery || document.write('<script src="assets/js/vendor/jquery-1.11.3.min.js"></script>'), "undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    "use strict";
    ...
    a.VERSION = "3.3.4", a.prototype.toggle = function(n) {
        var s = t(this);
    ...
    i.VERSION = "3.3.4", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                r = "bottom" == r && c.bottom + d > g.bottom ? "top" : "top" == r && c.top - d < g.top ? "bottom" : "right" == r && c.right + u > g.width ? "left" : "left" == r && c.left - u < g.left ? "right" : r, o.removeClass(p).addClass(r)
            }
...
function(t) {
    ...
    t(document).mouseup(function() {
        ...
        function() {
            ...
            t.position = {
                    ...
                    return y = n(_), _[0].preventDefault && (s.at = "left top"), g = y.width, m = y.height, v = y.offset, b = t.extend({}, v), t.each(["my", "at"], function() {
                        ...
                        "right" === s.my[0] ? I.left -= u : "center" === s.my[0] && (I.left -= u / 2), "bottom" === s.my[1] ? I.top -= d : "center" === s.my[1] && (I.top -= d / 2), I.left += S[0], I.top += S[1], o || (I.left = l(I.left), I.top = l(I.top)), n = {
                            ...
                            u > g && g > r(e + i) && (l.horizontal = "center"), d > m && m > r(n + o) && (l.vertical = "middle"), l.important = a(r(e), r(i)) > a(r(n), r(o)) ? "horizontal" : "vertical", s.using.call(this, t, l)
                        }), c.offset(t.extend(I, {
                            using: h
                        }))
                    })
                    ...
                    flip: {
                        ...
                        top: function(t, e) {
                            var i, n, s = e.within,
                                ...
                                g = -2 * e.offset[1];
                            0 > c ? (n = t.top + p + f + g + e.collisionHeight - a - o, (0 > n || r(c) > n) && (t.top += p + f + g)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + g - l, (i > 0 || u > r(i)) && (t.top += p + f + g))
                        }
                    },
                    flipfit: {
                        left: function() {
            ...
            drag: function(e, i, n) {
                ...
                for (d = n.snapElements.length - 1; d >= 0; d--) l = n.snapElements[d].left - n.margins.left, h = l + n.snapElements[d].width, c = n.snapElements[d].top - n.margins.top, u = c + n.snapElements[d].height, l - g > v || m > h + g || c - g > y || b > u + g || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                ...
                })), n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = g >= Math.abs(c - y), o = g >= Math.abs(u - b), a = g >= Math.abs(l - v), r = g >= Math.abs(h - m), s && (i.position.top = n._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: h
                }).left)), p = s || o || a || r, "outer" !== f.snapMode && (s = g >= Math.abs(c - b), o = g >= Math.abs(u - y), a = g >= Math.abs(l - m), r = g >= Math.abs(h - v), s && (i.position.top = n._convertPositionTo("relative", {
                    top: c,
                    left: 0
                }).top), o && (i.position.top = n._convertPositionTo("relative", {
    ...
    t.extend(s.prototype, {
        ...
        _generateHTML: function(t) {
            var e, i, n, s, o, a, r, l, h, c, u, d, p, f, g, m, v, b, y, _, w, x, C, k, T, D, I, S, E, N, P, A, M, H, O, z, W, F, L, R = new Date,
            ...
            for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = Y ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - V, 1)), this._getFormatConfig(t)) : i, n = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(t, "nextText"), s = Y ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : s, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + s + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (j ? "w" : "e") + "'>" + s + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : $, a = Y ? this.formatDate(a, r, this._getFormatConfig(t)) : a, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (j ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (j ? "" : l) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), b = this._get(t, "selectOtherMonths"), y = this._getDefaultDate(t), _ = "", x = 0; U[0] > x; x++) {
                for (C = "", this.maxRows = 4, k = 0; U[1] > k; k++) {
                    ...
                    for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === x ? j ? o : n : "") + (/all|right/.test(D) && 0 === x ? j ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || k > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", S = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) E = (w + c) % 7, S += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[E] + "'>" + p[E] + "</span></th>";
                    for (I += S + "</tr></thead><tbody>", N = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, N)), P = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, A = Math.ceil((P + N) / 7), M = X && this.maxRows > A ? this.maxRows : A, this.maxRows = M, H = this._daylightSavingAdjust(new Date(tt, Z, 1 - P)), O = 0; M > O; O++) {
                        for (I += "<tr>", z = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(H) + "</td>" : "", w = 0; 7 > w; w++) W = m ? m.apply(t.input ? t.input[0] : null, [H]) : [!0, ""], F = H.getMonth() !== Z, L = F && !b || !W[0] || Q && Q > H || J && H > J, z += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (H.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent || y.getTime() === H.getTime() && y.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !v ? "" : " " + W[1] + (H.getTime() === G.getTime() ? " " + this._currentClass : "") + (H.getTime() === $.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + H.getMonth() + "' data-year='" + H.getFullYear() + "'") + ">" + (F && !v ? "&#xa0;" : L ? "<span class='ui-state-default'>" + H.getDate() + "</span>" : "<a class='ui-state-default" + (H.getTime() === $.getTime() ? " ui-state-highlight" : "") + (H.getTime() === G.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + H.getDate() + "</a>") + "</td>", H.setDate(H.getDate() + 1), H = this._daylightSavingAdjust(H);
                        I += z + "</tr>"
                    }
    ...
    }, t.datepicker = new s, t.datepicker.initialized = !1, t.datepicker.uuid = (new Date).getTime(), t.datepicker.version = "1.11.4", t.datepicker, t.widget("ui.dialog", {
        version: "1.11.4",
        options: {
            appendTo: "body",
            autoOpen: !0,
    ...
    t.effects = {
        ...
        function() {
            ...
            for ((c || h) && r.push("opacity"), t.effects.save(a, r), a.show(), t.effects.createWrapper(a), d || (d = a["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && (o = {
                    opacity: 1
                }, o[v] = 0, a.css("opacity", 0).css(v, b ? 2 * -d : 2 * d).animate(o, g, m)), h && (d /= Math.pow(2, p - 1)), o = {}, o[v] = 0, n = 0; p > n; n++) s = {}, s[v] = (b ? "-=" : "+=") + d, a.animate(s, g, m).animate(o, g, m), d = h ? 2 * d : d / 2;
            h && (s = {
                opacity: 0
            ...
            var o, a, r, l, h, c, u = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3,
                ...
                y = [];
            for (o = 0; u > o; o++)
                for (l = m.top + o * b, c = o - (u - 1) / 2, a = 0; d > a; a++) r = m.left + a * v, h = a - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
                    position: "absolute",
                    visibility: "visible",
                    left: -a * v,
                    top: -o * b
